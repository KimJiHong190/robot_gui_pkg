...
robot_interfaces__msg__BridgeDt__init(robot_interfaces__msg__BridgeDt * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    robot_interfaces__msg__BridgeDt__fini(msg);
    return false;
  }
  // dt_can_tx
  // dt_can_tx_joint
...
robot_interfaces__msg__BridgeDt__create()
{
  ...
  robot_interfaces__msg__BridgeDt * msg = (robot_interfaces__msg__BridgeDt *)allocator.allocate(sizeof(robot_interfaces__msg__BridgeDt), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_interfaces__msg__BridgeDt));
  bool success = robot_interfaces__msg__BridgeDt__init(msg);
  if (!success) {
...
robot_interfaces__msg__BridgeDt__Sequence__init(robot_interfaces__msg__BridgeDt__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__BridgeDt * data = NULL;

  if (size) {
    data = (robot_interfaces__msg__BridgeDt *)allocator.zero_allocate(size, sizeof(robot_interfaces__msg__BridgeDt), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_interfaces__msg__BridgeDt__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_interfaces__msg__BridgeDt__fini(&data[i - 1]);
      }
...
robot_interfaces__msg__BridgeDt__Sequence__fini(robot_interfaces__msg__BridgeDt__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_interfaces__msg__BridgeDt__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__BridgeDt__Sequence * array = (robot_interfaces__msg__BridgeDt__Sequence *)allocator.allocate(sizeof(robot_interfaces__msg__BridgeDt__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_interfaces__msg__BridgeDt__Sequence__init(array, size);
  if (!success) {
...
robot_interfaces__msg__BridgeDt__Sequence__destroy(robot_interfaces__msg__BridgeDt__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_interfaces__msg__BridgeDt__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_interfaces__msg__BridgeDt__Sequence__are_equal(const robot_interfaces__msg__BridgeDt__Sequence * lhs, const robot_interfaces__msg__BridgeDt__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_interfaces__msg__BridgeDt__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_interfaces__msg__BridgeDt__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_interfaces__msg__BridgeDt);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_interfaces__msg__BridgeDt * data =
      (robot_interfaces__msg__BridgeDt *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_interfaces__msg__BridgeDt__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_interfaces__msg__BridgeDt__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_interfaces__msg__BridgeDt__copy(
