...
{
  new (message_memory) robot_interfaces::msg::BridgeError(_init);
}

void BridgeError_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::BridgeError *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BridgeError_message_member_array[5] = {
  {
    ...
    offsetof(robot_interfaces::msg::BridgeError, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::BridgeError, error_can),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::BridgeError, error_joint_stuck),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::BridgeError, is_error_over_current),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::BridgeError, is_error_over_range),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BridgeError_message_members = {
  ...
  5,  // number of fields
  sizeof(robot_interfaces::msg::BridgeError),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, BridgeError)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeError_message_type_support_handle;
}
