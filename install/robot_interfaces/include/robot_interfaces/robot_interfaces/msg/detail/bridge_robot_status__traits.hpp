...
#ifndef ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__TRAITS_HPP_
#define ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const robot_interfaces::msg::BridgeRobotStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const robot_interfaces::msg::BridgeRobotStatus & msg)
{
  return robot_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<robot_interfaces::msg::BridgeRobotStatus>()
{
  return "robot_interfaces::msg::BridgeRobotStatus";
}

template<>
inline const char * name<robot_interfaces::msg::BridgeRobotStatus>()
{
  return "robot_interfaces/msg/BridgeRobotStatus";
}

template<>
struct has_fixed_size<robot_interfaces::msg::BridgeRobotStatus>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<robot_interfaces::msg::BridgeRobotStatus>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<robot_interfaces::msg::BridgeRobotStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__TRAITS_HPP_
