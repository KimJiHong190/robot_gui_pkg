...
bool robot_interfaces__msg__bridge_robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._bridge_robot_status.BridgeRobotStatus", full_classname_dest, 59) == 0);
  }
  robot_interfaces__msg__BridgeRobotStatus * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BridgeRobotStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._bridge_robot_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BridgeRobotStatus");
