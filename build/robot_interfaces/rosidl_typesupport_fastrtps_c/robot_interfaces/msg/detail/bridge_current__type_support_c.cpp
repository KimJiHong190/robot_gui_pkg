...
#include "robot_interfaces/msg/detail/bridge_current__rosidl_typesupport_fastrtps_c.h"
...
using _BridgeCurrent__ros_msg_type = robot_interfaces__msg__BridgeCurrent;
...
size_t get_serialized_size_robot_interfaces__msg__BridgeCurrent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BridgeCurrent__ros_msg_type * ros_message = static_cast<const _BridgeCurrent__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BridgeCurrent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__BridgeCurrent(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__BridgeCurrent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BridgeCurrent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__BridgeCurrent(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, BridgeCurrent)() {
