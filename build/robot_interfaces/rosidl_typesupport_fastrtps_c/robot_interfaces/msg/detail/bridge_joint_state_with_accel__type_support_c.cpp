...
#include "robot_interfaces/msg/detail/bridge_joint_state_with_accel__rosidl_typesupport_fastrtps_c.h"
...
using _BridgeJointStateWithAccel__ros_msg_type = robot_interfaces__msg__BridgeJointStateWithAccel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BridgeJointStateWithAccel__ros_msg_type * ros_message = static_cast<const _BridgeJointStateWithAccel__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BridgeJointStateWithAccel__ros_msg_type * ros_message = static_cast<_BridgeJointStateWithAccel__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_robot_interfaces__msg__BridgeJointStateWithAccel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BridgeJointStateWithAccel__ros_msg_type * ros_message = static_cast<const _BridgeJointStateWithAccel__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BridgeJointStateWithAccel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__BridgeJointStateWithAccel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__BridgeJointStateWithAccel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BridgeJointStateWithAccel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__BridgeJointStateWithAccel(
...
static message_type_support_callbacks_t __callbacks_BridgeJointStateWithAccel = {
...
static rosidl_message_type_support_t _BridgeJointStateWithAccel__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BridgeJointStateWithAccel,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, BridgeJointStateWithAccel)() {
  return &_BridgeJointStateWithAccel__type_support;
}
