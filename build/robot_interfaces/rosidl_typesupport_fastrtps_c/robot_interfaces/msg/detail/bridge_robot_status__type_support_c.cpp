...
#include "robot_interfaces/msg/detail/bridge_robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _BridgeRobotStatus__ros_msg_type = robot_interfaces__msg__BridgeRobotStatus;

static bool _BridgeRobotStatus__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BridgeRobotStatus__ros_msg_type * ros_message = static_cast<const _BridgeRobotStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _BridgeRobotStatus__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _BridgeRobotStatus__ros_msg_type * ros_message = static_cast<_BridgeRobotStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_robot_interfaces__msg__BridgeRobotStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BridgeRobotStatus__ros_msg_type * ros_message = static_cast<const _BridgeRobotStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BridgeRobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__BridgeRobotStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__BridgeRobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BridgeRobotStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_robot_interfaces__msg__BridgeRobotStatus(
...
static message_type_support_callbacks_t __callbacks_BridgeRobotStatus = {
  "robot_interfaces::msg",
  "BridgeRobotStatus",
  _BridgeRobotStatus__cdr_serialize,
  _BridgeRobotStatus__cdr_deserialize,
  _BridgeRobotStatus__get_serialized_size,
  _BridgeRobotStatus__max_serialized_size
};

static rosidl_message_type_support_t _BridgeRobotStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BridgeRobotStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, BridgeRobotStatus)() {
  return &_BridgeRobotStatus__type_support;
}
