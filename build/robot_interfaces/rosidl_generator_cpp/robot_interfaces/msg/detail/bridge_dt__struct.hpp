...
#ifndef ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_DT__STRUCT_HPP_
#define ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_DT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__robot_interfaces__msg__BridgeDt __attribute__((deprecated))
#else
# define DEPRECATED__robot_interfaces__msg__BridgeDt __declspec(deprecated)
#endif
...
struct BridgeDt_
{
  ...
  // pointer types
  using RawPtr =
    robot_interfaces::msg::BridgeDt_<ContainerAllocator> *;
  using ConstRawPtr =
    const robot_interfaces::msg::BridgeDt_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      robot_interfaces::msg::BridgeDt_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__robot_interfaces__msg__BridgeDt
    std::shared_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__robot_interfaces__msg__BridgeDt
    std::shared_ptr<robot_interfaces::msg::BridgeDt_<ContainerAllocator> const>
...
using BridgeDt =
  robot_interfaces::msg::BridgeDt_<std::allocator<void>>;
...
#endif  // ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_DT__STRUCT_HPP_
