...
#ifndef ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
#define ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__robot_interfaces__msg__BridgeRobotStatus __attribute__((deprecated))
#else
# define DEPRECATED__robot_interfaces__msg__BridgeRobotStatus __declspec(deprecated)
#endif
...
struct BridgeRobotStatus_
{
  using Type = BridgeRobotStatus_<ContainerAllocator>;

  explicit BridgeRobotStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit BridgeRobotStatus_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__robot_interfaces__msg__BridgeRobotStatus
    std::shared_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__robot_interfaces__msg__BridgeRobotStatus
    std::shared_ptr<robot_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>
  ...
  bool operator==(const BridgeRobotStatus_ & other) const
  {
...
using BridgeRobotStatus =
  robot_interfaces::msg::BridgeRobotStatus_<std::allocator<void>>;
...
#endif  // ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
