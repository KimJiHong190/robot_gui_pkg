...
#ifndef ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ERROR__TRAITS_HPP_
#define ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ERROR__TRAITS_HPP_
...
inline void to_yaml(
  const robot_interfaces::msg::BridgeError & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const robot_interfaces::msg::BridgeError & msg)
{
  return robot_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<robot_interfaces::msg::BridgeError>()
{
  return "robot_interfaces::msg::BridgeError";
}

template<>
inline const char * name<robot_interfaces::msg::BridgeError>()
{
  return "robot_interfaces/msg/BridgeError";
}

template<>
struct has_fixed_size<robot_interfaces::msg::BridgeError>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robot_interfaces::msg::BridgeError>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<robot_interfaces::msg::BridgeError>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOT_INTERFACES__MSG__DETAIL__BRIDGE_ERROR__TRAITS_HPP_
