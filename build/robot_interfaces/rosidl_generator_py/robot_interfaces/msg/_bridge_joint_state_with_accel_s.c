...
bool robot_interfaces__msg__bridge_joint_state_with_accel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._bridge_joint_state_with_accel.BridgeJointStateWithAccel", full_classname_dest, 77) == 0);
  }
  robot_interfaces__msg__BridgeJointStateWithAccel * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BridgeJointStateWithAccel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._bridge_joint_state_with_accel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BridgeJointStateWithAccel");
