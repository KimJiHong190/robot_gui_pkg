...
#include "robot_interfaces/msg/detail/bridge_joint_state_with_accel__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::BridgeJointStateWithAccel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::BridgeJointStateWithAccel *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_BridgeJointStateWithAccel__handle;
}
