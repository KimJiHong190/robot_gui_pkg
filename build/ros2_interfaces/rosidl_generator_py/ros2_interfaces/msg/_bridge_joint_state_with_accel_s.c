...
bool ros2_interfaces__msg__bridge_joint_state_with_accel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.msg._bridge_joint_state_with_accel.BridgeJointStateWithAccel", full_classname_dest, 76) == 0);
  }
  ros2_interfaces__msg__BridgeJointStateWithAccel * ros_message = _ros_message;
  {  // header
...
PyObject * ros2_interfaces__msg__bridge_joint_state_with_accel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces.msg._bridge_joint_state_with_accel");
