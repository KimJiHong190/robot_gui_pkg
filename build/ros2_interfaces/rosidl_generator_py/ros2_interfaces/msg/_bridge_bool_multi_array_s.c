...
bool ros2_interfaces__msg__bridge_bool_multi_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.msg._bridge_bool_multi_array.BridgeBoolMultiArray", full_classname_dest, 65) == 0);
  }
  ros2_interfaces__msg__BridgeBoolMultiArray * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BridgeBoolMultiArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces.msg._bridge_bool_multi_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BridgeBoolMultiArray");
