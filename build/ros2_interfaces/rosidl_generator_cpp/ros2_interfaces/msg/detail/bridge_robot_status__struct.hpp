...
#ifndef ROS2_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
#define ROS2_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros2_interfaces__msg__BridgeRobotStatus __attribute__((deprecated))
#else
# define DEPRECATED__ros2_interfaces__msg__BridgeRobotStatus __declspec(deprecated)
#endif
...
struct BridgeRobotStatus_
{
  ...
  // pointer types
  using RawPtr =
    ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros2_interfaces__msg__BridgeRobotStatus
    std::shared_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros2_interfaces__msg__BridgeRobotStatus
    std::shared_ptr<ros2_interfaces::msg::BridgeRobotStatus_<ContainerAllocator> const>
...
using BridgeRobotStatus =
  ros2_interfaces::msg::BridgeRobotStatus_<std::allocator<void>>;
...
#endif  // ROS2_INTERFACES__MSG__DETAIL__BRIDGE_ROBOT_STATUS__STRUCT_HPP_
