...
#ifndef ROS2_INTERFACES__MSG__DETAIL__BRIDGE_CURRENT__STRUCT_HPP_
#define ROS2_INTERFACES__MSG__DETAIL__BRIDGE_CURRENT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros2_interfaces__msg__BridgeCurrent __attribute__((deprecated))
#else
# define DEPRECATED__ros2_interfaces__msg__BridgeCurrent __declspec(deprecated)
#endif
...
struct BridgeCurrent_
{
  ...
  // pointer types
  using RawPtr =
    ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros2_interfaces__msg__BridgeCurrent
    std::shared_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros2_interfaces__msg__BridgeCurrent
    std::shared_ptr<ros2_interfaces::msg::BridgeCurrent_<ContainerAllocator> const>
...
using BridgeCurrent =
  ros2_interfaces::msg::BridgeCurrent_<std::allocator<void>>;
...
#endif  // ROS2_INTERFACES__MSG__DETAIL__BRIDGE_CURRENT__STRUCT_HPP_
