...
#include "ros2_interfaces/msg/detail/bridge_error__rosidl_typesupport_fastrtps_c.h"
...
using _BridgeError__ros_msg_type = ros2_interfaces__msg__BridgeError;
...
size_t get_serialized_size_ros2_interfaces__msg__BridgeError(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BridgeError__ros_msg_type * ros_message = static_cast<const _BridgeError__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BridgeError__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interfaces__msg__BridgeError(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
size_t max_serialized_size_ros2_interfaces__msg__BridgeError(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BridgeError__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interfaces__msg__BridgeError(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_interfaces, msg, BridgeError)() {
