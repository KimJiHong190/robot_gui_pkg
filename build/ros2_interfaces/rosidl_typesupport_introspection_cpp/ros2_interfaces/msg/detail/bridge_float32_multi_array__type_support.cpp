...
{
  new (message_memory) ros2_interfaces::msg::BridgeFloat32MultiArray(_init);
}

void BridgeFloat32MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interfaces::msg::BridgeFloat32MultiArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BridgeFloat32MultiArray_message_member_array[3] = {
  {
    ...
    offsetof(ros2_interfaces::msg::BridgeFloat32MultiArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeFloat32MultiArray, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeFloat32MultiArray, float_values),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BridgeFloat32MultiArray_message_members = {
  ...
  3,  // number of fields
  sizeof(ros2_interfaces::msg::BridgeFloat32MultiArray),
...
{
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeFloat32MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces, msg, BridgeFloat32MultiArray)() {
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeFloat32MultiArray_message_type_support_handle;
}
