...
{
  new (message_memory) ros2_interfaces::msg::BridgeJointStateWithAccel(_init);
}

void BridgeJointStateWithAccel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interfaces::msg::BridgeJointStateWithAccel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BridgeJointStateWithAccel_message_member_array[5] = {
  {
    ...
    offsetof(ros2_interfaces::msg::BridgeJointStateWithAccel, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeJointStateWithAccel, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeJointStateWithAccel, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeJointStateWithAccel, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::msg::BridgeJointStateWithAccel, acceleration),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BridgeJointStateWithAccel_message_members = {
  ...
  5,  // number of fields
  sizeof(ros2_interfaces::msg::BridgeJointStateWithAccel),
...
{
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeJointStateWithAccel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces, msg, BridgeJointStateWithAccel)() {
  return &::ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::BridgeJointStateWithAccel_message_type_support_handle;
}
