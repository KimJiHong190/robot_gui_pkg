...
ros2_interfaces__msg__BridgeDt__init(ros2_interfaces__msg__BridgeDt * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ros2_interfaces__msg__BridgeDt__fini(msg);
    return false;
  }
  // dt_can_tx
  // dt_can_tx_joint
...
ros2_interfaces__msg__BridgeDt__create()
{
  ...
  ros2_interfaces__msg__BridgeDt * msg = (ros2_interfaces__msg__BridgeDt *)allocator.allocate(sizeof(ros2_interfaces__msg__BridgeDt), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_interfaces__msg__BridgeDt));
  bool success = ros2_interfaces__msg__BridgeDt__init(msg);
  if (!success) {
...
ros2_interfaces__msg__BridgeDt__Sequence__init(ros2_interfaces__msg__BridgeDt__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interfaces__msg__BridgeDt * data = NULL;

  if (size) {
    data = (ros2_interfaces__msg__BridgeDt *)allocator.zero_allocate(size, sizeof(ros2_interfaces__msg__BridgeDt), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_interfaces__msg__BridgeDt__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_interfaces__msg__BridgeDt__fini(&data[i - 1]);
      }
...
ros2_interfaces__msg__BridgeDt__Sequence__fini(ros2_interfaces__msg__BridgeDt__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_interfaces__msg__BridgeDt__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_interfaces__msg__BridgeDt__Sequence * array = (ros2_interfaces__msg__BridgeDt__Sequence *)allocator.allocate(sizeof(ros2_interfaces__msg__BridgeDt__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_interfaces__msg__BridgeDt__Sequence__init(array, size);
  if (!success) {
...
ros2_interfaces__msg__BridgeDt__Sequence__destroy(ros2_interfaces__msg__BridgeDt__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_interfaces__msg__BridgeDt__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_interfaces__msg__BridgeDt__Sequence__are_equal(const ros2_interfaces__msg__BridgeDt__Sequence * lhs, const ros2_interfaces__msg__BridgeDt__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_interfaces__msg__BridgeDt__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_interfaces__msg__BridgeDt__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_interfaces__msg__BridgeDt);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_interfaces__msg__BridgeDt * data =
      (ros2_interfaces__msg__BridgeDt *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_interfaces__msg__BridgeDt__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_interfaces__msg__BridgeDt__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_interfaces__msg__BridgeDt__copy(
