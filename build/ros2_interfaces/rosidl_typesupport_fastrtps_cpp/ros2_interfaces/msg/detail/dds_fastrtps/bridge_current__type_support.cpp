...
#include "ros2_interfaces/msg/detail/bridge_current__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_interfaces::msg::BridgeCurrent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interfaces::msg::BridgeCurrent & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const ros2_interfaces::msg::BridgeCurrent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interfaces::msg::BridgeCurrent *>(
    untyped_ros_message);
...
{
  return &ros2_interfaces::msg::typesupport_fastrtps_cpp::_BridgeCurrent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interfaces, msg, BridgeCurrent)() {
  return &ros2_interfaces::msg::typesupport_fastrtps_cpp::_BridgeCurrent__handle;
}
