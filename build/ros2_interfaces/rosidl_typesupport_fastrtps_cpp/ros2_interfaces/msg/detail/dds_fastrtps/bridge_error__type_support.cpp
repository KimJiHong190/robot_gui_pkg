...
#include "ros2_interfaces/msg/detail/bridge_error__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros2_interfaces::msg::BridgeError *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interfaces::msg::BridgeError *>(
    untyped_ros_message);
...
{
  return &ros2_interfaces::msg::typesupport_fastrtps_cpp::_BridgeError__handle;
}
